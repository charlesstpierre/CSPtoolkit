...
class WP_GitHub_Updater {
    ...
    public function get_github_readme() {
        if (isset($this->github_readme) && !empty($this->github_readme)) {
            $github_readme = $this->github_readme;
        } else {
            $github_readme = get_site_transient($this->config['slug'] . '_github_readme');
            ...
            if ($this->overrule_transients() || (!isset($github_readme) || !$github_readme || '' == $github_readme )) {
                ...
                $readme_response = wp_remote_get($readme_query, array('sslverify' => $this->config['sslverify']));
...
*/    }
    ...
    public function get_description() {
        ...
        return (!empty($_description->description) ) ? $_description->description : 'nop'; //false;
    }
